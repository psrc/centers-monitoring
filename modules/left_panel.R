  ...
  moduleServer(id, function(input, output, session) { 
    ...
    output$aleftpanel <- renderUI({
      ...
      bs4Jumbotron(
        ...
        hr(style = "border-top: 1px solid #000000;"),
        a(class = "source_url", href="https://www.psrc.org/media/5102", "Regional Growth Strategy", target="_blank"),
        hr(style = "border-top: 1px solid #000000;"),
        a(class = "source_url", href="https://www.psrc.org/planning-2050/vision/vision-2050-planning-resources", "VISION 2050 Planning Resources", target="_blank"),
        hr(style = "border-top: 1px solid #000000;"),
